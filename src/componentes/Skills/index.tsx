  ...
  return (
    <div className={estilos.conteiner}>
      ...
      <div className={estilos.skills}>
        ...
        <img src={javascript} alt="javascript" className={estilos.skills__icons} />
        <img src={typescript} alt="typescript" className={estilos.skills__icons} />
        ...
        <img src={tailwindcss} alt="tailwindcss" className={estilos.skills__icons} />
